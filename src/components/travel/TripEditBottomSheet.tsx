          ...
          >
            ...
            <div className="space-y-8">
              ...
              <button
                ...
                className="w-full h-15 bg-primary disabled:bg-slate-100 dark:disabled:bg-slate-800 text-white disabled:text-slate-300 rounded-2xl text-[16px] font-bold shadow-lg shadow-primary/20 transition-all active:scale-95 flex items-center justify-center gap-2 mt-4"
              >
                <Save size={18} />
                저장하기
              </button>
